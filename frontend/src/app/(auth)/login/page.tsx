...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center bg-black overflow-hidden px-4 py-8">
      ...
      <div className="w-full max-w-md flex flex-col items-center gap-6 z-10">
        {/* Login Card */}
        <div className="w-full bg-zinc-950/40 border border-zinc-800/80 backdrop-blur-xl rounded-2xl p-6 sm:p-8 shadow-2xl relative">
        ...
        <footer className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs text-zinc-500">
          <a
            href="https://wa.me/558396155351?text=Ol%C3%A1%2C%20preciso%20de%20suporte%20no%20docseq.%20Pode%20me%20ajudar%3F"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 hover:text-emerald-400 transition-colors py-1.5 px-3 rounded-lg hover:bg-zinc-900/60 active:scale-95"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 hover:text-zinc-300 transition-colors py-1.5 px-3 rounded-lg hover:bg-zinc-900/60 active:scale-95"
